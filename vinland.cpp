...
void skillTarget(mainCharacter &mc, enemies &enemy1, enemies &enemy2, enemies &enemy3, enemies &enemy4, bool &validSel, ally &ally1, ally &ally2, ally &ally3, items itemList[])
{
    ...
    while (validSel == false)
        ...
        {
        case 1:
            playerSkill(mc.skills[skillSelection + 1], mc, enemy1, enemy1, enemy2, enemy3, enemy4, ally1, ally2, ally3, itemList);
            break;
        case 2:
            if (enemy2.alive)
            {
                playerSkill(mc.skills[skillSelection + 1], mc, enemy2, enemy1, enemy2, enemy3, enemy4, ally1, ally2, ally3, itemList);
            }
            else
            {
                std::cout << "Invalid selection!\n";
        ...
        case 3:
            if (enemy3.alive)
            {
                playerSkill(mc.skills[skillSelection + 1], mc, enemy3, enemy1, enemy2, enemy3, enemy4, ally1, ally2, ally3, itemList);
            }
            else
            {
                std::cout << "Invalid selection!\n";
        ...
        case 4:
            if (enemy4.alive)
            {
                playerSkill(mc.skills[skillSelection + 1], mc, enemy4, enemy1, enemy2, enemy3, enemy4, ally1, ally2, ally3, itemList);
            }
            else
            {
                std::cout << "Invalid selection!\n";
...
void playerAttack(mainCharacter &mc, enemies &selectedEnemy, enemies &enemy1, enemies &enemy2, enemies &enemy3, enemies &enemy4)
{
    ...
    if (selectedEnemy.hp <= 0)
    {
        ...
        if (selectedEnemy.key == enemy1.key)
        {
            enemy1 = enemy2;
            enemy2 = enemy3;
            enemy3 = enemy4;
        ...
        if (selectedEnemy.key == enemy2.key)
        {
            enemy2 = enemy3;
            enemy3 = enemy4;
            enemy4.alive = false;
        }
        if (selectedEnemy.key == enemy3.key)
        {
            enemy3 = enemy4;
            enemy4.alive = false;
        }
...
void playerSkill(skills skill, mainCharacter &mc, enemies &selectedEnemy, enemies enemy1, enemies enemy2, enemies enemy3, enemies enemy4, ally ally1, ally ally2, ally ally3, items itemList[])
{
    ...
    selectedEnemy.hp -= (skill.dmg + (mc.mgk * 1.2) - selectedEnemy.def);
    if (selectedEnemy.hp <= 0)
    {
        std::cout << selectedEnemy.name << " was defeated!\n";
        selectedEnemy.alive = false;
        if (selectedEnemy.name == enemy1.name && selectedEnemy.hp == enemy1.hp)
        {
            enemy1 = enemy2;
            enemy2 = enemy3;
            enemy3 = enemy4;
